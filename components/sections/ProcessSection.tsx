...
export default function ProcessSection() {
  return (
    <section id="process" style={{ padding: "52px 0", background: "#f4f6fb", borderTop: "1px solid #e2e8f0", position: "relative", overflow: "hidden" }}>
      {/* YOUR uploaded export/process background image */}
      <div style={{
        position: "absolute", inset: 0,
        backgroundImage: "url('/images/EXPORT RJ.jpeg')",
        backgroundSize: "cover",
        backgroundPosition: "center",
        backgroundRepeat: "no-repeat",
      }} />
      <div style={{ position: "absolute", inset: 0, background: "rgba(244,246,251,0.88)" }} />
